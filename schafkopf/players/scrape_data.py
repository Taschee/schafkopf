...
card_encodings = {'Schellen-Sieben': (0, 0), 'Schellen-Acht': (1, 0), 'Schellen-Neun': (2, 0), 'Schellen-Unter': (3, 0),
                  'Der Runde': (4, 0), 'Schellen-König': (5, 0), 'Schellen-Zehn':(6, 0), 'Die Hundsgfickte': (7, 0),
                  ...
                  'Eichel-Sieben': (0, 3), 'Eichel-Acht': (1, 3), 'Eichel-Neun': (2, 3), 'Eichel-Unter': (3, 3),
                  'Der Alte': (4, 3), 'Eichel-König': (5, 3), 'Eichel-Zehn': (6, 3), 'Die Alte': (7, 3)}


def get_html(game_number):
...
def find_declaring_player_name(soup):
    title_tag = soup.find_all('meta', attrs={'name': 'twitter:title'})[0]
    title_str = title_tag['content']
    starting_index = None
...
def scrape_declaring_player_index(soup):
    name = find_declaring_player_name(soup)
